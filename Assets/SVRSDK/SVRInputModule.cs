...
{
    public class SVRInputModule : PointerInputModule
    {
        /// <summary>
        ...
        public interface InputSource
        {
            ...
            void UpdatePointerRay(SVRInputRayData rayData);

        }

        public static SVRInputModule instance { get; private set; }
        ...
        [NonSerialized]
        public SVRRaycaster activeGraphicRaycaster;
        ...
        protected void CopyFromTo(SVRPointerEventData @from, SVRPointerEventData @to)
        {
        ...
        protected Dictionary<int, SVRPointerEventData> m_VRRayPointerData = new Dictionary<int, SVRPointerEventData>();


        protected bool GetPointerData(int id, out SVRPointerEventData data, bool create)
        {
            if (!m_VRRayPointerData.TryGetValue(id, out data) && create)
            {
                data = new SVRPointerEventData(eventSystem)
                {
                    pointerId = id,
                };
        ...
        virtual protected MouseState GetMouseStateFromInputSource(InputSource inputSource, int id)
        {
            ...
            SVRPointerEventData leftData;
            GetPointerData(id, out leftData, true);
            leftData.Reset();

            SVRInputRayData rayData = new SVRInputRayData();
            ...
            if (handRay != null)
            {
                ...
                SVRRaycaster ovrRaycaster = raycast.module as SVRRaycaster;
            ...
            SVRPointerEventData rightData;
            GetPointerData(kMouseRightId, out rightData, true);
            CopyFromTo(leftData, rightData);
            rightData.button = PointerEventData.InputButton.Right;

            SVRPointerEventData middleData;
