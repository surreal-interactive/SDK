...
A simple and neat [Unity Starter Sample](https://github.com/surreal-interactive/Unity-StarterSamples) which is pretty similar to Oculus project is provided, there's a full-functionality scene where players can interact with and throw various game objects, showcasing the system's capabilities.
